...
CREATE TABLE
    `carrito` (
        `idCarrido` int(11) NOT NULL AUTO_INCREMENT,
        `idProducto` int(11) NOT NULL,
        `cantidad` INT(11) NOT NULL,
        PRIMARY KEY (`idCarrido`),
        CONSTRAINT `carretilla_user_key` FOREIGN KEY (`idProducto`) REFERENCES `productos` (`idProducto`) ON DELETE NO ACTION ON UPDATE NO ACTION
    );
